...
class Player(Movable):
  ...
  def jump(self):
    self.force_computer.velocity_vector[1] = -5
  ...
  def __init__(self, level):
    ...
    self.__init_attributes()
    self.force_computer.acceleration_vector[0] = self.level.gravity
...
class Renderer:
  ...
  def __init_attributes(self):
    ...
    enemy_flying_mask = pygame.image.load("resources/crow_flying_1_mask.bmp")
    self.enemy_flying_images.append(prepare_image(pygame.image.load("resources/crow_flying_1.bmp"),transparency_mask = enemy_flying_mask))
    enemy_flying_mask = pygame.image.load("resources/crow_flying_2_mask.bmp")
    self.enemy_flying_images.append(prepare_image(pygame.image.load("resources/crow_flying_2.bmp"),transparency_mask = enemy_flying_mask))
    enemy_flying_mask = pygame.image.load("resources/crow_flying_3_mask.bmp")
    self.enemy_flying_images.append(prepare_image(pygame.image.load("resources/crow_flying_3.bmp"),transparency_mask = enemy_flying_mask))
    enemy_flying_mask = pygame.image.load("resources/crow_flying_4_mask.bmp")
    self.enemy_flying_images.append(prepare_image(pygame.image.load("resources/crow_flying_4.bmp"), transparency_mask=enemy_flying_mask))
    enemy_flying_mask = pygame.image.load("resources/crow_flying_5_mask.bmp")
    self.enemy_flying_images.append(prepare_image(pygame.image.load("resources/crow_flying_5.bmp"), transparency_mask=enemy_flying_mask))
    enemy_flying_mask = pygame.image.load("resources/crow_flying_6_mask.bmp")
    self.enemy_flying_images.append(prepare_image(pygame.image.load("resources/crow_flying_6.bmp"), transparency_mask=enemy_flying_mask))

    self.enemy_ground_images = []
    enemy_ground_mask = pygame.image.load("resources/bomj_left_mask.bmp")
    self.enemy_ground_images.append(prepare_image(pygame.image.load("resources/bomj_left.bmp"),transparency_mask = enemy_ground_mask))
    enemy_ground_mask = pygame.image.load("resources/bomj_right_mask.bmp")
    self.enemy_ground_images.append(prepare_image(pygame.image.load("resources/bomj_right.bmp"),transparency_mask = enemy_ground_mask))
    enemy_ground_mask = pygame.image.load("resources/bomj_left_mask.bmp")
    self.enemy_ground_images.append(prepare_image(pygame.image.load("resources/bomj_left.bmp"),transparency_mask = enemy_ground_mask))
    ...
    egg_mask = pygame.image.load("resources/bread_mask.bmp")

    self.egg_image = prepare_image(pygame.image.load("resources/bread.bmp"),transparency_mask = egg_mask)
    ...
    self.player_images.standing.append(prepare_image(pygame.image.load("resources/pigeon_right_stand.bmp"),transparency_mask = pygame.image.load("resources/pigeon_right_stand_mask.bmp")))
    self.player_images.standing.append(pygame.transform.flip(self.player_images.standing[0],True,False))

    for i in range(1,7):
      self.player_images.moving_right.append(prepare_image(pygame.image.load("resources/pigeon_right_walk_" + str(i) + ".bmp"),transparency_mask = pygame.image.load("resources/pigeon_right_walk_" + str(i) + "_mask.bmp")))
      self.player_images.moving_left.append(pygame.transform.flip(self.player_images.moving_right[-1],True,False))

    self.player_images.jumping.append(prepare_image(pygame.image.load("resources/pigeon_right_jump_up_1.bmp"),transparency_mask = pygame.image.load("resources/pigeon_right_jump_up_1_mask.bmp")))
    self.player_images.jumping.append(prepare_image(pygame.image.load("resources/pigeon_right_jump_up_2.bmp"),transparency_mask = pygame.image.load("resources/pigeon_right_jump_up_2_mask.bmp")))
    self.player_images.jumping.append(prepare_image(pygame.image.load("resources/pigeon_right_jump_down_1.bmp"),transparency_mask = pygame.image.load("resources/pigeon_right_jump_down_1_mask.bmp")))
    self.player_images.jumping.append(prepare_image(pygame.image.load("resources/pigeon_right_jump_down_2.bmp"),transparency_mask = pygame.image.load("resources/pigeon_right_jump_down_2_mask.bmp")))
    ...
    self.player_images.special.append(prepare_image(pygame.image.load("resources/pigeon_right_quack.bmp"),transparency_mask = pygame.image.load("resources/pigeon_right_quack_mask.bmp")))
  ...
  def render_menu(self, menu):
    ...
    result.fill((220, 20, 60))


    result.blit(self.logo_image,(self.screen_width - self.logo_image.get_width(),self.screen_height - self.logo_image.get_height()))

    i = 0

    while i < len(menu.items):
      text_image = self.font_normal.render(menu.items[i],1,(0, 250, 154))
    ...
    while i < len(menu.text_lines):
      text_image = self.font_small.render(menu.text_lines[i],1,(32, 178, 170))
      ...
      for i in range(self.visible_tile_area[0],self.visible_tile_area[2]):
        ...
        if map_grid_object == None:
          ...
          if map_grid_object.object_type == MapGridObject.OBJECT_TILE:
            ...
            result.blit(self.spikes_image,(x + 20, y + 40))
            ...
            if self._level.eggs_left > 0:
              result.blit(self.teleport_inactive_image,(x,y + 40))
            else:
              result.blit(self.teleport_active_image,(x,y + 40))
  ...
  def set_camera_position(self, camera_x, camera_y):
    ...
    self.visible_tile_area = (helper_x - 2,helper_y - 2,helper_x + self.screen_width_tiles,helper_y + self.screen_height_tiles)
...
class Game:
  ...
  def __init__(self, name, fullscreen, sound):
    ...
    pygame.display.set_caption("Russian Golub")
    ...
    self.menu_main = Menu()
    self.menu_main.items.append("Novaya igra")
    self.menu_main.items.append("O razrabotchikah")
    self.menu_main.items.append("Vihod")

    self.menu_about = Menu()
    self.menu_about.items.append("back")
    self.menu_about.text_lines.append("Mantserov, Smirnov, Enikeev, Maslov, Bokov, 2021")
    ...
    self.menu_about.text_lines.append("ctrl = kurlik")
    self.menu_about.text_lines.append("space = flap wings")
    self.menu_about.text_lines.append("get all breads and get to the teleport")
